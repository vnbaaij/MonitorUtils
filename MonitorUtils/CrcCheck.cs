...
namespace MonitorUtils
{
    ...
    public class Crc16
    {
        ...
        public ushort ComputeChecksum(byte[] bytes, ushort startvalue)
        {
            ushort crc = startvalue;
        ...
        public byte[] ComputeChecksumBytes(byte[] bytes, ushort startvalue = 0)
        {
            ushort crc = ComputeChecksum(bytes, startvalue);
